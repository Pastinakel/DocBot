...
_Last updated: 2026-09-11 (fifth update, investigate an explicit telephony unlink mechanism). This file is a handover backlog, not a promise that every lower-priority idea must be implemented. Re-check repository/PR state before acting._
